...
class OnboardedClientModel {
  ...
  factory OnboardedClientModel.fromJson(Map<String, dynamic> json) {
    return OnboardedClientModel(
      defaultAccount: ExtendedExchangeAccountModel.fromJson(json['defaultAccount']),
    );
  }
...
class OnboardedAccount {
  ...
  factory OnboardedAccount.fromJson(Map<String, dynamic> json) {
    return OnboardedAccount(
      ...
      l2KeyPair: StarkKeyPair(
        private: BigInt.parse(json['l2KeyPair']['private'].substring(2), radix: 16),
        public: BigInt.parse(json['l2KeyPair']['public'].substring(2), radix: 16),
      ),
  ...
  @override
  String toString() => 'OnboardedAccount(vault: $l2Vault, apiKey: ${tradingApiKey?.substring(0, 8) ?? 'none'}...)';
}
...
class StarkKeyPair {
  ...
  @override
  String toString() => 'StarkKeyPair(private: ${privateHex.substring(0, 10)}..., public: $publicHex)';
}
...
class ApiKeyResponseModel {
  ...
  @override
  String toString() => 'ApiKeyResponse(key: ${key.substring(0, 8)}..., desc: $description)';
}
...
class OnboardingException implements Exception {
  ...
  @override
  String toString() => 'OnboardingException: $message${statusCode != null ? ' (Status: $statusCode)' : ''}';
}
