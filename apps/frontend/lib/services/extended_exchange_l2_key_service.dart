...
class ExtendedExchangeL2KeyService {
  ...
  static Future<StarkKeyPair> deriveL2Keys({
    ...
    final keyDerivationStruct = ExtendedExchangeCryptoUtils.createKeyDerivationStruct(
  ...
  static BigInt _generatePublicKeyFromPrivate(BigInt privateKey) {
    ...
    final starkFieldPrime = BigInt.parse('3618502788666131213697322783095070105623107215331596699973092056135872020481');
    final generatorPoint = BigInt.parse('874739451078007766457464989774322083649278607533249481151382481072868806602');
  ...
  static Future<bool> testKeyDerivation() async {
    ...
    const knownAddress = '0x742d35Cc6634C0532925a3b8D0C2A2b8E85b3b6b'; // Derived from private key
    const expectedL2Private = '0x7dbb2c8651cc40e1d0d60b45eb52039f317a8aa82798bda52eee272136c0c44';
    const expectedL2Public = '0x78298687996aff29a0bbcb994e1305db082d084f85ec38bb78c41e6787740ec';
    ...
    try {
      ...
      final privateMatch = derivedKeys.privateHex.toLowerCase() == expectedL2Private.toLowerCase();
      final publicMatch = derivedKeys.publicHex.toLowerCase() == expectedL2Public.toLowerCase();
