...
class ExtendedExchangeSignatureService {
  ...
  static final Map<String, Map<String, dynamic>> assetConfig = {
    ...
    'ETH-USD': {
      'synthetic_asset_id': '0x4554482d5553442d31000000000000', // From API response
      'collateral_asset_id': '0x2893294412a4c8f915f75892b395ebbf6859ec246ec365c3b1f56f47c3a0a5d',
      'synthetic_resolution': 1000000, // 6 decimals (10^6) 
      'collateral_resolution': 1000000, // 6 decimals (10^6)
    },
    'BTC-USD': {
      'synthetic_asset_id': '0x4254432d5553442d35000000000000', // From API response
      'collateral_asset_id': '0x2893294412a4c8f915f75892b395ebbf6859ec246ec365c3b1f56f47c3a0a5d',
  ...
  static Map<String, dynamic> generateOrderSignature({
    ...
    final amountCollateral = (qtyFloat * priceFloat * collateralResolution).toInt();
  ...
  static BigInt _getLimitOrderMsgWithoutBounds({
    ...
    packedMessage0 = packedMessage0 * BigInt.from(1 << 64) + BigInt.from(maxAmountFee);
    ...
    packedMessage1 = packedMessage1 * BigInt.from(1 << 32) + BigInt.from(positionId);
    packedMessage1 = packedMessage1 * BigInt.from(1 << 32) + BigInt.from(positionId);
    packedMessage1 = packedMessage1 * BigInt.from(1 << 32) + BigInt.from(positionId);
    packedMessage1 = packedMessage1 * BigInt.from(1 << 32) + BigInt.from(expirationTimestamp);
  ...
  static Map<String, BigInt> _generateStarkNetSignature(BigInt messageHash, BigInt privateKey) {
    try {
      ...
      final r = _deterministicSignatureValue(messageHash, privateKey, BigInt.one);
      final s = _deterministicSignatureValue(messageHash, privateKey, BigInt.two);
      return {'r': r, 's': s};
    } catch (e) {
  ...
  static BigInt _starknetGeneratorPoint() {
    return BigInt.parse('874739451078007766457464989774322083649278607533249481151382481072868806602');
  }
  
  /// Generate deterministic signature component
  static BigInt _deterministicSignatureValue(BigInt messageHash, BigInt privateKey, BigInt salt) {
